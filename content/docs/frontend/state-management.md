...
description: Server state, client state, URL state, and form state — choosing the right tool for each type in React and Next.js, structured for AI-assisted development.
---
# State Management

...
description: Programmatic SEO (pSEO) is the strategy of creating large numbers of targeted landing pages at scale using templates, databases, and automation. It targets long-tail keyword patterns that would be impractical to create manually.
---
# Programmatic SEO

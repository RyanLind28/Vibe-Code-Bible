...
description: "A local citation is any online mention of your business's Name, Address, and Phone number (NAP). Citations are a key local ranking factor — consistency and accuracy across the web directly impact your local search visibility."
---
# Local Citations

---
title: LLM Patterns
description: API integration with OpenAI, Anthropic, and Google, streaming responses, structured outputs, tool calling, multi-modal inputs, token management, rate limiting, fallback providers, and cost tracking — everything you need to ship AI features in production.
---
# LLM Patterns

---
title: Email Copy
description: Subject lines, welcome sequences, drip campaigns, transactional emails, newsletters, and link-building outreach — the copywriting that builds relationships in the inbox and drives traffic back to your site.
---
# Email Copy
...
| Element | Job | Character limit | Metric |
|---|---|---|---|
| Subject line | Earn the open | 30–50 chars (mobile safe) | Open rate |
| Preview text | Reinforce the open | 40–90 chars | Open rate |
| First sentence | Earn the read | ~20 words | Scroll depth |
| Body copy | Deliver value | 100–300 words (marketing) | Click rate |
| CTA | Earn the click | 3–7 words | Click-through rate |
...
| Email type | Default (boring) | Improved (branded) |
|---|---|---|
...
|---|---|---|
| Basic | First name | "Hey {FirstName}, here's your weekly digest" |
| Behavioral | Actions taken | "You downloaded the SEO guide — here's the advanced version" |
| Contextual | Lifecycle stage | "Day 3 of your trial: have you tried the analytics dashboard?" |
| Dynamic | Real-time data | "Your site's Core Web Vitals improved 15% this week" |
...
### 5. Writing Link Building Outreach Emails
...
### 4. Link Building Outreach Templates

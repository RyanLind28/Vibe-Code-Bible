...
description: Google Business Profile (formerly Google My Business) is the cornerstone of local SEO. It powers the Local Pack, Google Maps listings, and local Knowledge Panels. For businesses with a physical location or service area, GBP optimization is non-negotiable.
---
...
posting calendar, and priority actions.
```
...
Open daily 6am-6pm. Free parking available.
```

### Example 2: Review Response Templates
```
...
you giving us the opportunity to improve."
```

### Example 3: Weekly Google Posts Calendar
```
WEEK 1:
...
WEEK 4:
  ...
  Thu: "What's New" post — Customer testimonial + photo
```

### Example 4: Multi-Location Landing Page Template
```html

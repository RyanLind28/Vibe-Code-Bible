---
title: Search Intent
description: "Search intent is the *why* behind a query. Matching your content to user intent is the single most important on-page SEO factor. Google's entire algorithm is built around satisfying intent."
---
# Search Intent

...
description: Writing copy that ranks in search engines and converts human readers — keyword integration, content briefs, meta copy, on-page structure, and E-E-A-T signals woven into every sentence.
---
# SEO Copywriting
...
| Intent | Copy Tone | Copy Length | Primary Goal |
|--------|-----------|-------------|--------------|
| Informational | Educational, thorough | Long-form (1,500–3,000+ words) | Teach and build authority |
| Navigational | Clear, branded | Short, direct | Confirm arrival, reduce friction |
| Commercial | Consultative, comparative | Medium-form (1,000–2,000 words) | Help decide, build trust |
| Transactional | Action-oriented, concise | Short-form, focused | Convert, remove objections |
...
- **Natural within the sentence** — The link should read as part of a natural sentence. "Before writing any SEO copy, start with [solid keyword research](link)" is better than "For keyword research, [click here](link)."
...
### 6. Generic Anchor Text for Internal Links
...
**Fix:** Use descriptive, keyword-relevant anchor text that naturally describes the linked page. "Learn how to [build a content cluster](link)" tells both the reader and Google exactly what they will find on the linked page.

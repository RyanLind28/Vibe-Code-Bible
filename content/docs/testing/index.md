...
description: Test strategy, unit testing, end-to-end testing, and performance testing structured for AI-assisted development.
---
# Testing Vibe Coding Knowledge Base

> Test strategy, unit testing, end-to-end testing, and performance testing structured for AI-assisted development.
